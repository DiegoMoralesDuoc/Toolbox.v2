...
customElements.define('compodoc-menu', class extends HTMLElement {
    ...
    render(isNormalMode) {
        ...
        <nav>
            <ul class="list">
                <li class="title">
                    <a href="index.html" data-type="index-link">toolbox documentation</a>
                </li>
                ...
                <li class="chapter">
                    ...
                    <li class="chapter">
                        ...
                        <ul class="links collapse " ${ isNormalMode ? 'id="components-links"' : 'id="xs-components-links"' }>
                            ...
                            <li class="link">
                                <a href="components/Herramientas.html" data-type="entity-link" >Herramientas</a>
                            </li>
                            <li class="link">
                                <a href="components/Listalluser.html" data-type="entity-link" >Listalluser</a>
                            </li>
                            <li class="link">
                                <a href="components/Login.html" data-type="entity-link" >Login</a>
                            </li>
                            <li class="link">
                                <a href="components/Materiales.html" data-type="entity-link" >Materiales</a>
                            </li>
                            <li class="link">
                                <a href="components/Perfil.html" data-type="entity-link" >Perfil</a>
                            </li>
                            <li class="link">
                                <a href="components/Proyectos.html" data-type="entity-link" >Proyectos</a>
                            </li>
                            <li class="link">
                            ...
                            <li class="link">
                                <a href="components/Soporte.html" data-type="entity-link" >Soporte</a>
                            </li>
                            <li class="link">
                    ...
                    <li class="chapter">
                        ...
                        <ul class="links collapse " ${ isNormalMode ? ' id="interfaces-links"' : 'id="xs-interfaces-links"' }>
                            <li class="link">
                                <a href="interfaces/Herramienta.html" data-type="entity-link" >Herramienta</a>
                            </li>
                            <li class="link">
                                <a href="interfaces/MaterialCategoria.html" data-type="entity-link" >MaterialCategoria</a>
                            </li>
                            <li class="link">
                                <a href="interfaces/MaterialCategoria-1.html" data-type="entity-link" >MaterialCategoria</a>
                            </li>
                            <li class="link">
                                <a href="interfaces/MaterialDetalle.html" data-type="entity-link" >MaterialDetalle</a>
                            </li>
                            <li class="link">
                                <a href="interfaces/MaterialDetalle-1.html" data-type="entity-link" >MaterialDetalle</a>
                            </li>
                            <li class="link">
                                <a href="interfaces/Proyecto.html" data-type="entity-link" >Proyecto</a>
                            </li>
                            <li class="link">
                                <a href="interfaces/Proyecto-1.html" data-type="entity-link" >Proyecto</a>
                            </li>
                            <li class="link">
                                <a href="interfaces/SmallBox.html" data-type="entity-link" >SmallBox</a>
                            </li>
                            <li class="link">
